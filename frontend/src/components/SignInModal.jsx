    ...
    <Dialog open={open} onOpenChange={(v) => { if (!v) { reset(); onClose(); } }}>
      <DialogContent className="sm:max-w-sm rounded-2xl border-border bg-card">
        <DialogHeader className="text-center">
          <span className="w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-blue-700 flex items-center justify-center mx-auto mb-2 shadow-[0_0_18px_rgba(138,43,226,0.6)]">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <Button type="submit" disabled={loading} className="w-full h-10 rounded-sm bg-primary text-white hover:bg-primary/90 font-bold">
