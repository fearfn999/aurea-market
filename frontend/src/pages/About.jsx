      ...
      <section className="relative z-10 max-w-4xl mx-auto px-6 py-16">
        <div className="rounded-2xl bg-card border border-border p-10 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link to="/products"><Button data-testid="about-shop-btn" className="rounded-lg h-12 px-8 bg-primary hover:bg-primary/90 text-white font-bold shadow-lg shadow-blue-500/20">Browse the store <ArrowRight size={18} className="ml-2" /></Button></Link>
