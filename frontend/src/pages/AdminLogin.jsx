      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md relative z-10">
        <div className="rounded-sm border border-border bg-card p-8">
          ...
          <form onSubmit={submit} className="space-y-5" data-testid="admin-login-form">
            ...
            <Button type="submit" disabled={loading} data-testid="admin-login-btn" className="w-full rounded-sm h-11 bg-primary hover:bg-primary/90 text-white font-bold transition-colors active:scale-95">
