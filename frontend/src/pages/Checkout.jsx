    ...
    <div className="max-w-5xl mx-auto px-6 pt-28 pb-20 min-h-screen">
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        <div className="rounded-xl border border-border bg-card p-6 space-y-5" data-testid="checkout-form">
          ...
          {method === "card" ? (
            <Button onClick={payStripe} disabled={submitting} data-testid="pay-btn" className="w-full rounded-lg h-12 bg-red hover:bg-amber text-white font-bold transition-colors active:scale-95">
