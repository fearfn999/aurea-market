    ...
    <div className="min-h-screen">
        ...
        {pending ? (
          ...
          <>
            ...
            <div className="flex justify-between items-center mb-5">
              ...
              <Button onClick={openNew} data-testid="seller-add-product-btn" className="rounded-lg bg-primary hover:bg-primary/90 text-white font-bold">
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="bg-card border-border max-w-lg max-h-[90vh] overflow-y-auto rounded-xl">
          ...
          <DialogFooter><Button onClick={save} data-testid="sform-save-btn" className="rounded-lg bg-primary hover:bg-primary/90 text-white font-bold w-full">{editing ? "Save changes" : "List product"}</Button></DialogFooter>
        </DialogContent>
      </Dialog>
    </div>
  );
